...
/**
 * @title NiftyERC1155
 * @dev Extends standard ERC1155 contract from OpenZeppelin
 */
contract NiftyERC1155 is Ownable, ERC1155 {
    ...
    //     uint256 seedOwnerRoyalty = _getSeedOwnerCut(printPrice - reserveCut);
    //     // Mint token
    ...
    //     return string(abi.encodePacked(uri(), _uint2str(_id), ".json"));
    // }
    // /***********************************|
    ...
    //         (bool success, ) =
    //             msg.sender.call{value: msg.value - printPrice}("");
