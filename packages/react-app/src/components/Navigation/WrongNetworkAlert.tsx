...
const WrongNetworkAlert = (): JSX.Element | null => {
      ...
      <Alert
        ...
        description={
          unsupportedNetwork ? (
            ...
            <div>
              You have <b>{selectedChainId && NETWORK(selectedChainId).name}</b> selected and you need to be on{' '}
              <b>{localChainId && NETWORK(localChainId).name}</b>.
            </div>
          )
        }
        type="error"
