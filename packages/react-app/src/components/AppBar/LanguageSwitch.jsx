...
import HeFlag from "../../assets/images/flags/he-flag.png";
import RoFlag from "../../assets/images/flags/ro-flag.png";
import RuFlag from "../../assets/images/flags/ru-flag.png";
import ViFlag from "../../assets/images/flags/vi-flag.png";
...
function LanguageSwitch() {
  ...
  return (
    <StyledMenu ref={node}>
      ...
      {open && (
        <ExtendedMenuFlyout>
          {Object.entries(LANGUAGES).map(([key, { flag, lang, dialect }]) => (
            <MenuItem onClick={() => onClick(key)} key={key}>
              <MenuItemFlag src={flag} alt={lang} />
              {lang}{" "}
              {dialect && (
                <sup>
                  <small>{dialect}</small>
