          ...
          <section id="cd-timeline" className="cd-container">
            <div className="cd-timeline-block fade-in">
              ...
              <div className="cd-timeline-content">
                ...
                <p>
                  Working alongside the designer team implementing the designs, also developing custom solutions to
            ...
            <div className="cd-timeline-block fade-in">
              ...
              <div className="cd-timeline-content">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut
            ...
            <div className="cd-timeline-block fade-in">
              ...
              <div className="cd-timeline-content">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut
                  hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui
                  ut.
                </p>
              </div>
            </div>
