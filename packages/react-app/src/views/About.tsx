  ...
  return (
    <Container style={{ textAlign: 'left', padding: '40px' }}>
      ...
      <p>
        ...
        direction of Nifty League. The sale of our characters will coincide with the initial distribution of our
        ecosystem’s native currency and governance token <strong>NFTL</strong>. <strong>NFTL</strong> serves a dual
        purpose of giving users voting rights on upcoming games and tournaments as well as being used for expenses
        platform-wide. This includes naming characters, and purchases within our upcoming NFT store where players can
        buy additional in-game items and collectibles. Any <strong>NFTL</strong> used for naming characters along with{' '}
